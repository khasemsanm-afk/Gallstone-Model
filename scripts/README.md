...
13. [สเต็ป 9: Deploy ขึ้น Server จริง](#-สเต็ป-9-deploy-ขึ้น-server-จริง)
14. [Checklist สรุปรายการตรวจสอบ](#-checklist-สรุปรายการตรวจสอบ)
15. [FAQ ปัญหาที่พบบ่อย](#-faq-ปัญหาที่พบบ่อย)
...
```
ระบบ SS โรงพยาบาล → ส่งข้อความอัลตราซาวด์ → FastAPI Backend (คัดกรอง) → Ollama AI (วิเคราะห์) → ส่ง JSON กลับ SS
```
